...
**Note: The application is live and deployed. You can access the live versions of the web app using the following links: [Live Demo](https://freshmartneo.pythonanywhere.com/) and [FastAPI Live Demo](https://fresh-mart-ecommerce-fastapi.onrender.com/docs)**
